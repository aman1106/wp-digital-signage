...
class My_List_Table extends WP_List_Table {
    ...
    function __construct() {
        parent::__construct(array(
            'singular' => 'Alert ', //Singular label
            'plural' => 'Alerts', //plural label
            ...
            foreach ($_POST['display'] as $display) {
                ...
                if (!$delete) {
                    ...
                    <div class="notice notice-error is-dismissible">
                        <p><?php _e('Could not delete Alert. Please try again or contact support', 'sample-text-domain'); ?></p>
                    </div>
                    <?php
                } else if ($delete > 0) {
                    ?>
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            'id' => array('id', false),
            'display_id' => array('display_id', false),
    ...
    function column_id($item) {
        $actions = array(
            'edit' => sprintf('<a href="?page=wpds_alerts&new_al=true&edit_alert=%s">Edit</a>', $item['id']),
            'delete' => sprintf('<a href="?page=wpds_alerts&del_alert=%s">Delete</a>', $item['id']),
        );
...
echo '<div class="wrap"><h2>Alerts <a style="float:right" href="admin.php?page=wpds_alerts&new_al=true"><input type="submit" name="show_add" value="Add New Alert »" class="button-primary"></a></h2><br />';
?>
