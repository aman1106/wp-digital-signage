...
//$this->items = $a;
    ...
    function column_id($item) {
        $actions = array(
            'edit' => sprintf('<a href="?page=wpds_floormaps&new_fm=true&edit_floormap=%s">Edit</a>', $item['id']),
            'delete' => sprintf('<a href="?page=wpds_floormaps&del_floormap=%s">Delete</a>', $item['id']),
            'displays' => sprintf('<a href="?page=wpds_floormaps&new_fm=true&floormap_displays=%s">Displays</a>', $item['id'])
        );
...
echo '<div class="wrap"><h2>Floormap Manager<a style="float:right" href="admin.php?page=wpds_floormaps&new_fm=true"><input type="submit" name="show_add" value="Create New Floormap »" class="button-primary"></a></h2><br />';?>
